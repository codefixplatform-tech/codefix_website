  ...
  return (
    <div className={`bg-background text-slate-900 overflow-hidden font-sans ${isDashboard ? 'pt-10' : ''}`}>
      ...
      <section className={`relative overflow-hidden ${isDashboard ? 'py-10' : 'pt-32 pb-24 lg:pt-56 lg:pb-40'}`}>
        ...
        <div className="max-w-[1400px] mx-auto px-8 sm:px-16 lg:px-24 text-center space-y-10">
           <motion.div {...fadeIn} className="inline-flex items-center gap-3 bg-slate-900 text-white px-6 py-2 rounded-full border border-white/10 shadow-2xl">
              ...
              <span className="text-[10px] font-bold tracking-[4px] uppercase">The Story of Codefix</span>
           </motion.div>
         ...
         <div className="max-w-[1400px] mx-auto px-8 sm:px-16 lg:px-24">
            <div className="grid lg:grid-cols-2 gap-24 items-center">
               <motion.div {...fadeIn} className="space-y-12">
                   <h2 className="text-4xl sm:text-6xl font-bold font-heading text-slate-900 leading-[1] tracking-tighter">Precision Engineering. <br /><span className="bg-gradient-to-r from-primary via-indigo-600 to-purple-600 bg-clip-text text-transparent">Infinite Velocity.</span></h2>
               ...
               >
                  ...
                  <div className="relative bg-slate-900 rounded-[4rem] p-12 md:p-20 shadow-3xl overflow-hidden border border-white/5 text-white">
      ...
      <section className="py-32 bg-slate-50/50">
         <div className="max-w-[1400px] mx-auto px-8 sm:px-16 lg:px-24">
            <div className="text-center mb-24 space-y-6">
               <h2 className="text-4xl sm:text-6xl font-bold font-heading text-slate-900 tracking-tighter">The Full <span className="bg-gradient-to-r from-primary via-indigo-600 to-purple-600 bg-clip-text text-transparent">Stack Sync.</span></h2>
      ...
      <section className="py-32 bg-slate-900 text-white relative overflow-hidden">
         ...
         <div className="max-w-[1400px] mx-auto px-8 sm:px-16 lg:px-24 flex flex-col lg:flex-row items-center gap-24 relative z-10">
            <div className="lg:w-1/2 space-y-10">
               <h2 className="text-4xl sm:text-6xl font-bold font-heading text-white tracking-tighter leading-[1]">A Global <br /><span className="bg-gradient-to-r from-primary via-indigo-600 to-purple-600 bg-clip-text text-transparent">Engineering Hub.</span></h2>
            ...
            <div className="lg:w-1/2 relative flex justify-center">
               ...
               <FaGlobeAmericas className="text-[200px] md:text-[400px] text-primary/40 animate-pulse relative z-10" />
            </div>
         </div>
      </section>
      ...
      <section className="py-32 bg-white border-b border-slate-100">
         <div className="max-w-[1400px] mx-auto px-8 sm:px-16 lg:px-24 flex flex-col lg:flex-row-reverse items-center gap-24">
            <div className="lg:w-1/2 space-y-10 text-right lg:text-left">
               <h2 className="text-4xl sm:text-6xl font-bold font-heading text-slate-900 tracking-tighter leading-[1]">Military-Grade <br /><span className="bg-gradient-to-r from-primary via-indigo-600 to-purple-600 bg-clip-text text-transparent">Data Isolation.</span></h2>
      ...
      <section className="py-32 bg-slate-50/30">
         <div className="max-w-[1400px] mx-auto px-8 sm:px-16 lg:px-24 grid lg:grid-cols-2 gap-20 items-center">
            <div className="space-y-10">
               <h2 className="text-4xl sm:text-6xl font-bold font-heading text-slate-900 tracking-tighter leading-[1]">The Human <br /><span className="bg-gradient-to-r from-primary via-indigo-600 to-purple-600 bg-clip-text text-transparent">Component.</span></h2>
            ...
            <div className="bg-white p-12 rounded-[4rem] border border-slate-200 shadow-2xl relative group">
               ...
               <p className="text-slate-500 text-lg leading-relaxed italic font-medium">"Our goal is to reduce the cognitive load of engineering. We want developers to focus on creation, while Codefix handles the utility."</p>
            </div>
         </div>
      </section>
      ...
      <section className="py-32 bg-white border-t border-slate-100">
         <div className="max-w-[1400px] mx-auto px-8 sm:px-16 lg:px-24 flex flex-col lg:flex-row items-center gap-24">
            <div className="lg:w-1/2 space-y-10">
               <h2 className="text-4xl sm:text-6xl font-bold font-heading text-slate-900 tracking-tighter leading-[1]">Shaping the <br /><span className="bg-gradient-to-r from-primary via-indigo-600 to-purple-600 bg-clip-text text-transparent">Future Roadmap.</span></h2>
            ...
            <div className="lg:w-1/2">
               <div className="bg-slate-900 p-12 rounded-[3.5rem] text-white shadow-3xl">
         ...
         <div className="max-w-[1400px] mx-auto px-8 sm:px-16 lg:px-24">
             ...
             >
                ...
                <div className="relative z-10 space-y-12">
                   <h2 className="text-5xl md:text-8xl font-bold mb-10 tracking-tight leading-none">The Future <br /> is Neural.</h2>
                   <p className="text-white/70 text-lg md:text-xl font-medium max-w-2xl mx-auto tracking-tight leading-relaxed">Join the next generation of engineers building secure, high-velocity applications on Codefix.</p>
                   <div className="flex flex-col sm:flex-row items-center justify-center gap-8 pt-8">
                     ...
                     <Link to="/tools">
                        <button className="bg-black/20 text-white border border-white/20 backdrop-blur-xl px-16 py-7 rounded-[2.5rem] font-black text-xs uppercase tracking-[6px] hover:bg-white/10 transition-all">Explore Architecture</button>
                     </Link>
                   </div>
                </div>
             </motion.div>
...
const TechBadge = ({ icon, label }) => (
   <div className="bg-white border border-slate-200 p-8 rounded-[2.5rem] flex flex-col items-center gap-4 hover:shadow-xl transition-all group">
...
const ValueBox = ({ icon, title, desc }) => (
   <div className="bg-slate-50 p-12 rounded-[3.5rem] border border-slate-100 text-center space-y-6 group hover:bg-white hover:shadow-2xl transition-all duration-700">
...
const SecurityPoint = ({ icon, title }) => (
   <div className="bg-slate-50 p-8 rounded-3xl border border-slate-200 flex flex-col items-center gap-4 hover:border-primary/40 transition-all group">
