  ...
  return (
    <div className={`relative min-h-screen bg-background text-slate-900 overflow-hidden font-sans ${isDashboard ? 'pt-10' : ''}`}>
      ...
      <section className={`relative overflow-hidden ${isDashboard ? 'py-10' : 'pt-24 pb-16 md:pt-36 md:pb-24 lg:pt-44 lg:pb-32'}`}>
        ...
        <div className="max-w-[1400px] mx-auto px-8 sm:px-16 lg:px-24 text-center space-y-8 sm:space-y-12">
           <motion.div {...fadeIn} className="inline-flex items-center gap-3 bg-slate-900 text-white px-4 py-1.5 sm:px-6 sm:py-2 rounded-full border border-white/10 shadow-2xl max-w-full">
              <FaLayerGroup className="text-primary text-[10px] shrink-0" />
              <span className="text-[8px] sm:text-[10px] font-bold tracking-[2px] sm:tracking-[4px] uppercase truncate max-w-[180px] xs:max-w-none">Neural Document Core v2.0</span>
           </motion.div>
           
           <motion.h1 {...fadeIn} className="text-5xl sm:text-7xl md:text-[100px] font-semibold font-heading text-slate-900 leading-[1.1] tracking-[-0.04em] mb-6 sm:mb-10">
              The Neural <br />
      ...
      <section className="pb-16 md:pb-24">
         <div className="max-w-[1400px] mx-auto px-8 sm:px-16 lg:px-24">
            <div className="bg-white border border-slate-200 p-6 sm:p-12 md:p-16 rounded-[2rem] sm:rounded-[3rem] md:rounded-[4rem] flex flex-col md:flex-row items-center gap-8 md:gap-12 shadow-sm hover:shadow-xl transition-all text-slate-900 relative overflow-hidden group">
               <div className="absolute top-0 right-0 p-8">
                  <div className="w-40 h-40 bg-emerald-500/5 blur-3xl rounded-full group-hover:bg-emerald-500/10 transition-all"></div>
               </div>
               <div className="w-24 h-24 bg-emerald-50/50 rounded-[2rem] flex items-center justify-center text-emerald-500 text-4xl shadow-sm border border-emerald-100 relative z-10 shrink-0">
                  <FaShieldAlt />
               </div>
               <div className="space-y-4 sm:space-y-6 text-center md:text-left relative z-10 flex-1">
                  <h3 className="text-3xl sm:text-4xl md:text-5xl font-semibold font-heading leading-tight tracking-tight">Neural <br /><span className="bg-gradient-to-r from-emerald-500 to-teal-600 bg-clip-text text-transparent">Privacy Protocol.</span></h3>
               ...
               <div className="flex-shrink-0 relative z-10 w-full md:w-auto text-center md:text-left">
                  <div className="inline-block bg-slate-900 text-white px-6 py-3 sm:px-10 sm:py-4 rounded-xl sm:rounded-2xl font-bold uppercase tracking-[4px] text-[10px] shadow-2xl">Local Processing</div>
               </div>
            </div>
         </div>
      </section>
