        ...
        <div className="max-w-[1400px] mx-auto px-8 sm:px-16 lg:px-24 relative">
          <div className="flex flex-col items-center text-center">
            <motion.div 
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              className="inline-flex items-center gap-3 bg-slate-900 text-white px-3 py-1.5 rounded-full mb-10 shadow-2xl border border-white/10"
            >
              <div className="w-5 h-5 rounded-full bg-primary flex items-center justify-center text-white shadow-sm shadow-primary/30 shrink-0">
                <FaBolt size={9} />
              </div>
